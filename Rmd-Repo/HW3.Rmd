...
There is a .267 proportion of total draws that are between 65 and 75; there proportion of the sample that is both less than 48 and greater than 88 is 0.

##### 2.3 (1 pts) Why are your answers to question 2 close to those in question 1? Why are they not exactly the same?

Since we're using simulation to build the distribution, we know that as the number of simulations increases we get a closer approximation to the distribution itself; its a shitty version of law of large numbers.
---
